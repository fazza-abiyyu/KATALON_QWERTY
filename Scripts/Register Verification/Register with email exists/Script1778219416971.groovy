...
WebUI.setText(findTestObject('Register/email_field'), email)

WebUI.setText(findTestObject('Register/password_field'), password)

WebUI.setText(findTestObject('Register/verify_password_field'), password)

WebUI.click(findTestObject('Register/btn_create_account'))

WebUI.click(findTestObject('Register/msg_email_already_registered'))
