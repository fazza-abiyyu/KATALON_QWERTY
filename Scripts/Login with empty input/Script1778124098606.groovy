...
WebUI.click(findTestObject('Login with empty input/Page_QWERTY E-Commerce/icon_sign-in'))
...
WebUI.click(findTestObject('Login with empty input/Page_QWERTY E-Commerce/btn_sign-in'))
