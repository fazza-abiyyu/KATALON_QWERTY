...
WebUI.newTab(url +'/emailer-simulator')

WebUI.click(findTestObject('Reset password/first_item_mailler_otp'))

String otpCode = WebUI.getText(findTestObject('Reset password/text_otp_code'))

WebUI.switchToWindowIndex(0)

WebUI.setText(findTestObject('Reset password/otp_code_field'), otpCode)
