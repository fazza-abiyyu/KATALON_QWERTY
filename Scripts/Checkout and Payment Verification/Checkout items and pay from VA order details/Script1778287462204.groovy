...
WebUI.click(findTestObject('Checkout and payment/btn_icon_profile'))

WebUI.click(findTestObject('Checkout and payment/span_my_order'))

WebUI.delay(5)

WebUI.click(findTestObject('Checkout and payment/first_item_on_my_order_page'))

WebUI.click(findTestObject('Checkout and payment/span_pending'))

String vaCode = WebUI.getText(findTestObject('Checkout and payment/text_va_code_on_order_details'))
